...
//вывод 6
        ...
        System.out.println("rectangle " + firstRectangle.toString());
        System.out.println(" rectangle " + firstRectangle);
      ...
      //  System.out.println(firstRectangle.equals(firstRectangle,anotherRectangle));
        ...
        //  firstRectangle.area=firstRectangle.height*firstRectangle.with;
        firstRectangle.stetWith(4);
        System.out.println("area= " + firstRectangle.calculateArea());
    }
